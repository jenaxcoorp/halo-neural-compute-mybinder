...
This repository is prepared for MyBinder with a minimal FastAPI service on port 50080 to validate Jupyter proxy routing. On launch, open the URL above; once Jupyter starts, navigate to `/proxy/50080/`.
